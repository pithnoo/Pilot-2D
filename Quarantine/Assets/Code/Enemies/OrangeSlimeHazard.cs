...
public class OrangeSlimeHazard : MonoBehaviour
{
    public AudioManager theAudioManager;
    private Rigidbody2D rb;
    public LevelManager theLevelManager;
    public bool hazardBoxActive;
    ...
    void Update()
    {
        ...
        else if(theLevelManager.hazBoxActive == true){

            if(hazardBoxActive == true){
                rb.isKinematic = true;
                hazardBoxActive = false;
            } 
